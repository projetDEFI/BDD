...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 08 mai 2019 à 19:56
...
CREATE TABLE IF NOT EXISTS `plateforme` (
  ...
  `couverture_geo_donnees` int(7) DEFAULT NULL,
  `couverture_chrono_donnees` int(7) DEFAULT NULL,
