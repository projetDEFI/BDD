...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 01 mai 2019 à 17:32
...
(1, 'Biologie, médecine et santé'),
(2, 'Mathématiques et leurs interactions'),
(3, 'Physique'),
(4, 'Chimie'),
(5, 'Sciences de la terre et de l\'univers, espace'),
(6, 'Sciences humaines et humanités'),
(7, 'Sciences agronomiques et écologiques'),
(8, 'Sciences de la société'),
(9, 'Sciences pour l\'ingénieur'),
...
(1, 'Métadonnées de description'),
(2, 'Document structuré'),
(3, 'Visualisation'),
(4, 'Métadonnées d\'indexation');
...
(5, 'Lien social'),
(6, 'Création d’activité économique');
