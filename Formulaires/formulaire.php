...
<link rel=\"stylesheet\" href=\"styles.css\" />
  ...
  <link rel=\"stylesheet\" href=\"/resources/demos/style.css\">
		...
		<script src=\"jquery.easy-autocomplete.min.js\" type=\"text/javascript\" ></script>
...
echo "<SELECT name=\"langue[]\" id=\"langue\" size=10 multiple>" ; 
while ($donnees=$reponse->fetch())
{ 
...
<input type=\"radio\" name=\"couverturechrono\" value=\"Antiquite\"> Antiquité </TD><TD>
<input type=\"radio\" name=\"couverturechrono\" value=\"Moyen Age\"> Moyen-Âge </TD></TR><TR><TD>
<input type=\"radio\" name=\"couverturechrono\" value=\"Renaissance\"> Renaissance </TD><TD>
<input type=\"radio\" name=\"couverturechrono\" value=\"Epoque moderne\"> Epoque moderne </TD><TD>
<input type=\"radio\" name=\"couverturechrono\" value=\"Lumieres\"> Lumières </TD></TR><TR><TD>
<input type=\"radio\" name=\"couverturechrono\" value=\"19eme siecle\"> 19ème siècle </TD><TD>
<input type=\"radio\" name=\"couverturechrono\" value=\"20eme siecle\"> 20ème siècle </TD><TD>
  ...
  $( function() {
    ...
    $( "#institution" )
      ...
      .autocomplete({
		...
		$("#lieupilote").easyAutocomplete(geo1);
		...
		$("#couverturegeo").easyAutocomplete(geo2);
</script>
